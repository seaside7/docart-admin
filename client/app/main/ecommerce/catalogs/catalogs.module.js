  ...
  function config($stateProvider, msNavigationServiceProvider, $translatePartialLoaderProvider) {
    $stateProvider
      .state('app.catalogs', {
        ...
        views  : {
            'content@app': {
                templateUrl: 'app/main/ecommerce/catalogs/catalogs.html',
                controller : 'CatalogsController as vm'
            }
        }
    });

    $translatePartialLoaderProvider.addPart('app/main/ecommerce/catalogs');

    msNavigationServiceProvider.saveItem('commerce.catalogs', {
            title    : 'Catalogs',
