...
export function index(req, res) {
    ...
    options.populate = [{path: 'sender', select: 'name email imageUrl'}];
...
export function create(req, res) {
    ...
    return ProductComment.create(req.body)
...
export function destroy(req, res) {
    ...
    return ProductComment.findOne({_id: req.params.id, sender: req.user._id}).exec()
